...
namespace Particle3DSample
{
    ...
    public abstract class ParticleSystem : DrawableGameComponent
    {
        ...
        {
            Effect effect = content.Load<Effect>(TGCGame.ContentFolderEffects + "ParticleEffect");
            ...
            Texture2D texture = content.Load<Texture2D>(TGCGame.ContentFolderTextures + "Particles/" + settings.TextureName);
