...
float4 MainPS(VertexShaderOutput input) : COLOR
{
    ...
    float metallic = 0.0; //tex2D(metallicSampler, input.TextureCoordinates).r;
    float roughness = 0.5; //tex2D(roughnessSampler, input.TextureCoordinates).r;
    float ao = 1.0; //tex2D(aoSampler, input.TextureCoordinates).r;
